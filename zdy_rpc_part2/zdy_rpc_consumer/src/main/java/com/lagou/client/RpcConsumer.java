...
public class RpcConsumer {
    ...
    public Object createProxy(final Class<?> serviceClass, String hostName, Integer port){
        //借助JDK动态代理生成代理对象
    ...
    //2.初始化netty客户端
    public static  void initClient(String host, Integer port) throws InterruptedException {
